...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 01, 2022 at 11:00 AM
...
INSERT INTO `pembayaran` (`id_pembayaran`, `tgl_bayar`, `total`, `id_transaksi`) VALUES
(1, '2022-08-01 15:56:00', 75000, 1);
...
(1, 'Mita Zuriati', '08234567890', 'Bandung');
...
INSERT INTO `transaksi` (`id_transaksi`, `id_barang`, `id_pembeli`, `tgl_transaksi`, `keterangan`) VALUES
(1, 1, 1, '2022-08-01 15:52:00', 'Original');
